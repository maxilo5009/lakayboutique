...
require 'connexionBase.php';
 utf8_encode($category_name);

//ensemble des variable
//
...
//_virtuemart_category_categories
 	...
 	$reponse = $db->query('SELECT MAX(id) AS id FROM na2uf_virtuemart_category_categories');
...
'INSERT INTO na2uf_virtuemart_categories_fr_fr (virtuemart_category_id, category_name, category_description, metadesc, metakey, customtitle, slug) VALUES (:virtuemart_category_id, :category_name, :category_description, :metadesc, :metakey, :customtitle, :slug)');
 ...
 $req = $db->prepare('INSERT INTO na2uf_virtuemart_categories_fr_fr (virtuemart_category_id, category_name, category_description, metadesc, metakey, customtitle, slug)
 			 VALUES (:$virtuemart_category_id, :$category_name, :$category_description, :$metadesc, :$metakey, :$customtitle, :$slug)');
